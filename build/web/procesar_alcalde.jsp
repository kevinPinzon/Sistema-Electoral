<%-- 
    Document   : procesar_alcalde
    Created on : 30-mar-2018, 6:41:01
    Author     : alex
--%>
...
<%
    String dir = "";
        ...
        while (i.hasNext()) {
            ...
            if (!ft.isFormField()) {//cuando es un archivo
                ...
                if (cont == 1) {
                    ...
                    session.setAttribute("municipio", ft.getString());
                }else if (cont == 3) {
        ...
        request.getRequestDispatcher("agregar_alcalde").forward(request, response);
%>