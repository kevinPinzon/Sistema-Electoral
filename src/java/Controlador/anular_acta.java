 ...
 * @author alex
 */
@WebServlet(name = "anular_acta", urlPatterns = {"/anular_acta"})
public class anular_acta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Mesa_Electoral.update_estado_acta(mesa_electoral.getId(),2);
            
            request.getRequestDispatcher("cargar_mesas_electorales_magistrado").forward(request, response);            
        }
    }
