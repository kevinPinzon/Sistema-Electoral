 ...
 * @author alex
 */
@WebServlet(name = "cargar_resultados_globales_alcalde_admin", urlPatterns = {"/cargar_resultados_globales_alcalde_admin"})
public class cargar_resultados_globales_alcalde_admin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("resultado_alcalde_admin.jsp").forward(request, response);
        }
    }
