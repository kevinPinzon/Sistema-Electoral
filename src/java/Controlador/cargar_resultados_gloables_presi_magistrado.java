 ...
 * @author alex
 */
@WebServlet(name = "cargar_resultados_gloables_presi_magistrado", urlPatterns = {"/cargar_resultados_gloables_presi_magistrado"})
public class cargar_resultados_gloables_presi_magistrado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("resultado_presidente_magistrado.jsp").forward(request, response);
        }
    }
