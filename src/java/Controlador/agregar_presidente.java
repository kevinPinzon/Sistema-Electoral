 ...
 * @author alex
 */
@WebServlet(name = "agregar_presidente", urlPatterns = {"/agregar_presidente"})
public class agregar_presidente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String insertar = candidato.insertar(id,id_pp,1,0,0,nombre,imagen);
