 ...
 * @author alex
 */
@WebServlet(name = "cargar_resultados_globales_diputados_admin", urlPatterns = {"/cargar_resultados_globales_diputados_admin"})
public class cargar_resultados_globales_diputados_admin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("resultado_diputados_admin.jsp").forward(request, response);
        }
    }
