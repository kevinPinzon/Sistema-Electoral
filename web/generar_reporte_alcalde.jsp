<%-- 
    Document   : generar_reporte_alcalde
    Created on : 05-abr-2018, 9:02:19
    Author     : alex
--%>
...
<%
  List<Candidato_pp> resultados_gloables_alcalde = (List<Candidato_pp>) session.getAttribute("resultados_gloables_alcalde");
  String municipio_name = (String) session.getAttribute("municipio_name");
  
    //configurar el header y el tipo
    response.setContentType("application/pdf");
    response.setHeader("Content-Disposition", 
            "attachment; filename=\"Reporte de resutados alcaldia "+municipio_name+".pdf\"");
    ...
    try {
        ...
        document.addSubject("Reporte de resutados alcaldia "+municipio_name);
        ...
        "<br>" +
        "<h2 style='text-align: center;'>Reporte de resutados alcaldia "+municipio_name+" 2018</h2>"+
        "<br><br>"+                
        ...
        for (Candidato_pp presi_current : resultados_gloables_alcalde) {
            contador++;
            String str_temp = "<tr>"+
                "<td>"+contador+"</td>"+
