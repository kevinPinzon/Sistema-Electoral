<%-- 
    Document   : graficas_alcalde_global
    Created on : 07-abr-2018, 7:12:51
    Author     : alex
--%>
...
<%
    List<Candidato_pp> presidentes_planilla_resultado = (ArrayList<Candidato_pp>) session.getAttribute("resultados_gloables_alcalde");
    ...
    int total_votos=0;
    double porcentaje = 0;
    String municipio= (String) session.getAttribute("municipio_name");
    ...
    //generar el grafico
    JFreeChart grafico = ChartFactory.createPieChart("Resultados de Alcaldes Municipio "+municipio+" 2018", data,true,true,true);
