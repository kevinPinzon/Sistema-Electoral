<%-- 
    Document   : graficas_presidente_global
    Created on : 07-abr-2018, 6:02:19
    Author     : alex
--%>
...
<%
    List<Candidato_pp> presidentes_planilla_resultado = (ArrayList<Candidato_pp>) session.getAttribute("resultados_gloables_presidente");
    ...
    //generar el grafico
    JFreeChart grafico = ChartFactory.createPieChart("Resultados Presidenciales Honduras 2018", data,true,true,true);
