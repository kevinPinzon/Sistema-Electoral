<%-- 
    Document   : lista_magistrados
    Created on : 04-abr-2018, 7:44:44
    Author     : alex
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <h1 style="text-align: center;">Magistrados</h1>
            <br>
                ...
                <div class="card col-12 col-md-8" style="padding:0px;">
                    <table class="table" style="text-align: center;">
                        ...
                        <tbody>
                            <%
                                contador = 1;
                                list_magistrados = (ArrayList<Magistrado>) request.getAttribute("list_magistrados");
                                for (Magistrado magistrado_current : list_magistrados) {
                            %>
                            <tr>
                                <th scope="row"><%=contador++%></th>
                                <td><%=magistrado_current.getId()%></td>
                                <td><%=magistrado_current.getNombre()%></td>
                                <td>
            ...
            <div class="row justify-content-center">
                <div class="card col-12 col-md-4" style="padding:0px;">
                    <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#newadmin">Crear Nuevo Magistrado</button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Nuevo Magistrado</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="agregar_magistradp" method="post">
                            <div class="form-group row">
                                <label for="magistrado_nombre" class="col-sm-3 col-form-label">Nombre: </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="admin_nombre" name="magistrado_nombre">
                                    <br>
                                </div>
                                <label for="magistrado_pass" class="col-sm-3 col-form-label">Contraseña: </label>
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" id="admin_pass" name="magistrado_pass">
                                </div>
                                <div class="col-sm-10" style="display:none;">
                                    <input type="number" class="form-control" name="magistrado_id"
                                           value="<%=contador++%>">
                                </div>
                            </div>                                     
