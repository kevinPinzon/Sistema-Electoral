<%-- 
    Document   : resultados_globales_magistrado
    Created on : 05-abr-2018, 18:02:54
    Author     : alex
--%>
                ...
                <div class="col-6 col-md-4">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="cargar_resultados_gloables_presi_magistrado" class="btn btn-primary">Ver mas</a>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="cargar_resultados_globales_alcalde_magistrado" class="btn btn-primary">Ver mas</a>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="cargar_resultados_globales_diputados_magistrado" class="btn btn-primary">Ver mas</a>
                        </div>
                    </div>
                </div>                
            </div>
