...
<html>
    ...
    <body>
         ...
         <div class="container-fluid">
             ...
             <h1 style="text-align: center;">Partido Politico Azul</h1>
             <br>
             ...
             <div class="row justify-content-center">
                 <div class="card col-12 col-md-4" style="padding:0px;">
                     <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#exampleModal">Agregar Nuevo Candidato</button>
                 </div>
             </div>
         </div>        
    </body>
