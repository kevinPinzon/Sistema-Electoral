<%-- 
    Document   : resultados_alcalde_miembro
    Created on : 04-abr-2018, 0:15:22
    Author     : alex
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <h1 style="text-align: center;">Resultados Alcaldia del Municipio <%=session.getAttribute("municipio_name")%></h1>
            <br>
            <div class="row justify-content-center">
                <div class="card col-12 col-md-8" style="padding:0px;">
                    ...
                    <table class="table" style="text-align: center;">
                        ...
                        <tbody>
                            <%
                                alcaldes_planilla_resultado = (ArrayList<Candidato_pp>) session.getAttribute("alcaldes_planilla_resultado");
