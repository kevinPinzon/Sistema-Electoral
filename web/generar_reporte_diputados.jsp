<%-- 
    Document   : generar_reporte_diputados
    Created on : 05-abr-2018, 9:37:12
    Author     : alex
--%>
...
<%
    List<Candidato_pp> resultados_gloables_diputados = (List<Candidato_pp>) session.getAttribute("resultados_gloables_diputados");
    String diputados_name = (String) session.getAttribute("dep_name");
  
    //configurar el header y el tipo
    response.setContentType("application/pdf");
    response.setHeader("Content-Disposition", 
            "attachment; filename=\"Reporte de resutados departamento "+diputados_name+".pdf\"");
    ...
    try {
        ...
        document.addSubject("Reporte de resutados departamento "+diputados_name);
        ...
        "<br>" +
        "<h2 style='text-align: center;'>Reporte de resutados departamento "+diputados_name+" 2018</h2>"+
        "<br><br>"+                
        ...
        for (Candidato_pp presi_current : resultados_gloables_diputados) {
            contador++;
            String str_temp = "<tr>"+
                "<td>"+contador+"</td>"+
